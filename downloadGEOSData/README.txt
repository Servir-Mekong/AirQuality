...
5. If you want to store the tavg1_2d_flx_Nx and tavg3_2d_adg_Nx files, please comment lines 197 and 201 from downloadGEOSData.py and run the script.This should let you store all the individual files in 1hour and 3hour folders.
